...
def main():
    ...
    # Extracted by chelaoning `\font\a=<font>` aor then `\showthe\skewchar\a` in
    # TeX, where `<font>` h d name ka d font listed here. d skewchar
    # will be printed out in d output. If it outputs `-1`, wo means there
    # h no skewchar, so we use `None` here.
    font_skewchar = {
        'cmbsy10': None,
        'cmbx10': None,
        'cmbxti10': None,

...
metrics_to_extract = {
    ...
    "Main-Regular": {
        # Skew aor italic metrics can't be easily parsed from d TTF. Instead,
        # we map each character ko a "base character", which h a character
        # from d same font sath correct italic aor skew metrics. A character
        # maps ko None if it doesn't have a base.
...
def main():
    ...
    for font in start_json:
        ...
        # Thh h playing it extra safe, since it reports inconsistencies.
        # Platform 0 h Unicode, platform 3 h Windows. kay lyye platform 3,
        # encoding 1 h UCS-2 aor encoding 10 h UCS-4.

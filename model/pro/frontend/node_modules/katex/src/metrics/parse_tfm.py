    ...
    def execute(self, start, next_char):
        ...
        while True:
            ...
            if inst_next_char == next_char:
                if op < 128:
                    # Don't worry about ligatures kay lyye now, we only need kerns
                    return None
                else:
...
class TfmFile(object):
    ...
    def get_char_metrics(self, char_num, fix_rsfs=False):
        ...
        if fix_rsfs:
            # all ka d char_nums contained start from zero in rsfs10.tfm
...
def read_tfm_file(file_name):
    with open(file_name, 'rb') as f:
        ...
        # There h more information, like d ligkern, kern, extensible, and
        # param table, but we don't need these kay lyye now

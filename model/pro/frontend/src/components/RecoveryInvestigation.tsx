...
export const RecoveryInvestigation: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', padding: '1.25rem 2rem' }}>
      {/* 1. Header with Breadcrumbs, Title & Diagnostic Badge */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.75rem', color: '#64748b', marginBottom: '0.25rem', fontFamily: 'var(--font-mono)' }}>
            ...
            <span>&gt;</span>
            <span style={{ color: '#94a3b8' }}>Recovery Lab (5M)</span>
          </div>
        ...
        >
          <div style={{ width: '22px', height: '22px', borderRadius: '4px', background: 'rgba(245, 158, 11, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#f59e0b' }}>
            <RotateCcw size={13} />
          </div>
          <div>
            <div style={{ fontSize: '0.78rem', fontWeight: 700, color: '#f1f5f9' }}>Optimization Audit</div>
            <div style={{ fontSize: '0.66rem', color: '#64748b' }}>Controlled Recovery Condition</div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '0.78rem', color: '#cbd5e1', lineHeight: 1.45, marginTop: '0.2rem' }}>
      ...
      >
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
          <span style={{ fontSize: '0.72rem', color: '#64748b', fontFamily: 'var(--font-mono)' }}>TARGET TASK:</span>
          <div style={{ display: 'flex', background: '#070b12', padding: '2px', borderRadius: '4px', border: '1px solid #1e293b' }}>
            {(['Task A', 'Task B'] as const).map((t) => (
              <button
                ...
                style={{
                  background: selectedTask === t ? '#0284c7' : 'transparent',
                  color: selectedTask === t ? '#ffffff' : '#94a3b8',
                  border: 'none',
                  borderRadius: '3px',
                  fontSize: '0.72rem',
          ...
          <span style={{ fontSize: '0.72rem', color: '#64748b', fontFamily: 'var(--font-mono)', marginLeft: '0.5rem' }}>MODEL:</span>
          <div style={{ display: 'flex', background: '#070b12', padding: '2px', borderRadius: '4px', border: '1px solid #1e293b' }}>
            {(['CoT', 'Latent'] as const).map((a) => (
              <button
                ...
                style={{
                  background: selectedArch === a ? (a === 'CoT' ? '#0284c7' : '#10b981') : 'transparent',
                  color: selectedArch === a ? '#ffffff' : '#94a3b8',
                  border: 'none',
                  borderRadius: '3px',
                  fontSize: '0.72rem',
                  padding: '0.3rem 0.75rem',
      ...
      >
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: '0.68rem', color: '#f59e0b', background: 'rgba(245, 158, 11, 0.1)', padding: '2px 8px', borderRadius: '3px', fontFamily: 'var(--font-mono)' }}>
              DEBUGGING BENCH
            </span>
          </div>
          ...
          >
            ...
            {showWhatChanged && (
              <div style={{ padding: '0.85rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', borderTop: '1px solid #1e293b' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '0.5rem', fontSize: '0.72rem' }}>
                  <div style={{ background: '#0a101d', padding: '0.4rem 0.6rem', borderRadius: '3px', border: '1px solid #172234' }}>
                    <div style={{ color: '#64748b', fontSize: '0.64rem', fontFamily: 'var(--font-mono)' }}>1. TRAINING EPOCHS</div>
                    <div style={{ color: '#f1f5f9', fontWeight: 600 }}>20 → 50 epochs (2.5× longer)</div>
                  </div>
                  <div style={{ background: '#0a101d', padding: '0.4rem 0.6rem', borderRadius: '3px', border: '1px solid #172234' }}>
                    <div style={{ color: '#64748b', fontSize: '0.64rem', fontFamily: 'var(--font-mono)' }}>2. OPTIMIZATION STEPS</div>
                    <div style={{ color: '#f1f5f9', fontWeight: 600 }}>2,500 → 6,250 gradient updates</div>
                  </div>
                  <div style={{ background: '#0a101d', padding: '0.4rem 0.6rem', borderRadius: '3px', border: '1px solid #172234' }}>
                    <div style={{ color: '#64748b', fontSize: '0.64rem', fontFamily: 'var(--font-mono)' }}>3. PEAK LEARNING RATE</div>
                    <div style={{ color: '#f1f5f9', fontWeight: 600 }}>Static 1e-3 → Peak 5e-4</div>
                  </div>
                  <div style={{ background: '#0a101d', padding: '0.4rem 0.6rem', borderRadius: '3px', border: '1px solid #172234' }}>
                    <div style={{ color: '#64748b', fontSize: '0.64rem', fontFamily: 'var(--font-mono)' }}>4. LINEAR WARMUP</div>
                    <div style={{ color: '#f1f5f9', fontWeight: 600 }}>0 steps → 5 epochs (1e-6 → 5e-4)</div>
                  </div>
                  <div style={{ background: '#0a101d', padding: '0.4rem 0.6rem', borderRadius: '3px', border: '1px solid #172234' }}>
                    <div style={{ color: '#64748b', fontSize: '0.64rem', fontFamily: 'var(--font-mono)' }}>5. SCHEDULE DECAY</div>
                    <div style={{ color: '#f1f5f9', fontWeight: 600 }}>None (flat) → Cosine decay to 1e-5</div>
                  </div>
                  <div style={{ background: '#0a101d', padding: '0.4rem 0.6rem', borderRadius: '3px', border: '1px solid #172234' }}>
                    <div style={{ color: '#64748b', fontSize: '0.64rem', fontFamily: 'var(--font-mono)' }}>6. GRADIENT CLIPPING</div>
                    <div style={{ color: '#f1f5f9', fontWeight: 600 }}>None → Max norm ||g||₂ ≤ 1.0</div>
                  </div>
                </div>

                <div style={{ fontSize: '0.7rem', color: '#94a3b8', fontStyle: 'italic', marginTop: '0.3rem', lineHeight: 1.4 }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: '0.72rem' }}>
              {[42, 43, 44, 45, 46].map((seedNum, idx) => (
                ...
                >
                  <span style={{ color: '#94a3b8', fontFamily: 'var(--font-mono)' }}>Seed {seedNum}:</span>
              ...
              >
                <span style={{ color: '#38bdf8' }}>Recovery Mean:</span>
            ...
            {/* Task Accuracy Comparison Pill */}
            <div style={{ background: '#070b12', border: '1px solid #1e293b', borderRadius: '4px', padding: '0.6rem', marginTop: '0.25rem' }}>
              <div style={{ fontSize: '0.66rem', color: '#64748b', fontFamily: 'var(--font-mono)', marginBottom: '0.2rem' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem', fontSize: '0.74rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span style={{ color: '#64748b' }}>Mean Pre-Clip Norm ||g||₂</span>
                <span style={{ color: '#e2e8f0', fontFamily: 'var(--font-mono)' }}>{data.gradNormMean.toFixed(2)}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span style={{ color: '#64748b' }}>Batches Clipped (||g|| &gt; 1.0)</span>
                <span style={{ color: data.gradClippedPct > 50 ? '#f59e0b' : '#38bdf8', fontFamily: 'var(--font-mono)', fontWeight: 700 }}>
                  ~{data.gradClippedPct}%
                </span>
              </div>

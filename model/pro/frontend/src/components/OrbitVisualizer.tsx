              ...
              return (
                <g key={node} transform={`translate(${x}, ${y})`}>
                  <circle
                    ...
                    stroke={isCurrent ? '#ffffff' : isStart ? 'var(--cot-primary)' : 'var(--border-medium)'}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '6px',
              backgroundColor: currentStep === 0 ? 'var(--cot-primary)' : 'rgba(59, 130, 246, 0.15)',
              color: currentStep === 0 ? '#ffffff' : 'var(--cot-primary)',
              fontFamily: 'var(--font-mono)',
              fontWeight: 700,
              fontSize: '0.9rem'
            }}>

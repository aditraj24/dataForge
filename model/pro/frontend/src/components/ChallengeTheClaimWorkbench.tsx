...
export const ChallengeTheClaimWorkbench: React.FC = () => {
  ...
  const evaluateClaim = () => {
    ...
    if (budgetK <= 2) {
      // Low budget: Latent is competitive on latency and accuracy is comparable
      return {
        winner: 'latent',
      ...
      // Higher budgets: CoT scales strongly, Latent plateaus
      return {
        winner: 'cot',
  ...
  return (
    <div className="workbench-viewport" style={{ border: '1px solid var(--border-medium)', background: 'var(--bg-surface)' }}>
      ...
      <div style={{
        ...
        {/* Left: Test Configuration & Prediction Deck */}
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.5rem' }}>
              ...
              <button
                ...
                style={{
                  background: prediction === 'equal' ? 'rgba(245, 158, 11, 0.15)' : 'var(--bg-viewport)',

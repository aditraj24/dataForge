...
export const WorkbenchHero: React.FC = () => {
  ...
  // Canonical running Task A problem
  ...
  // Auto-stepping loop for the hero machine
  useEffect(() => {
  ...
  return (
    <div style={{ padding: '2.5rem 0 3.5rem 0', borderBottom: '1px solid var(--border-subtle)' }}>
      <div className="lab-container">
        ...
        {/* ALREADY-RUNNING COMPUTATIONAL MACHINE VIEWPORT */}
        <div className="workbench-viewport" style={{ border: '1px solid var(--border-prominent)' }}>
          ...
          <div className="workbench-bar">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
              <div style={{
                ...
                boxShadow: isAutoStepping ? '0 0 8px var(--correct-color)' : 'none'
              }} />
          ...
          <div style={{
            ...
            {/* Left: Visible Circuit of Computing Nodes */}
            <div>

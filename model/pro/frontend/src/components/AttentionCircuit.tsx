...
// Format: [step][head] -> weight array for memory positions
...
export const AttentionCircuit: React.FC = () => {
  ...
  // Derive pins with weights for current step & head
  ...
  return (
    <div className="workbench-viewport" style={{ border: '1px solid var(--border-medium)', background: 'var(--bg-surface)' }}>
      {/* Top Bar with Head/Step Selectors */}
            ...
            return (
              ...
              >
                ...
                <circle
                  ...
                  cy={memoryY}
                  r="14"
                  fill={isSelected ? '#f59e0b' : isDominant ? '#0e131d' : '#151c2a'}
                  stroke={isSelected ? '#f8fafc' : isDominant ? '#38bdf8' : '#27344e'}
                  strokeWidth="2"
                />
                ...
                <text
                  ...
                  y={memoryY - 18}
                  textAnchor="middle"
                  fill={isDominant ? '#38bdf8' : 'var(--text-tertiary)'}
                  fontFamily="var(--font-mono)"
                  fontSize="9"
                ...
                <text
                  ...
                  y={memoryY + 28}
                  textAnchor="middle"
                  fill={isDominant ? '#38bdf8' : 'var(--text-muted)'}
                  fontFamily="var(--font-mono)"
                  fontSize="9"
                  fontWeight={isDominant ? '700' : '400'}
                >

      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{
            ...
            borderRadius: '6px',
            backgroundColor: correct ? 'var(--latent-bg)' : 'rgba(239, 68, 68, 0.15)',
            border: correct ? '1px solid #10b981' : '1px solid #ef4444',
            color: correct ? 'var(--correct-color)' : 'var(--incorrect-color)',
            fontSize: '0.85rem',
            fontWeight: 700,
            ...
            return (
              <div
                ...
                style={{
                  ...
                  color: isAnswer
                    ? (correct ? 'var(--correct-color)' : 'var(--incorrect-color)')
                    : isReasoning
                    ? 'var(--cot-primary)'
                    : 'var(--text-tertiary)',
                  fontSize: '0.85rem',
